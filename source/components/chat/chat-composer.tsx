...
import { capturePhoto, pickFromLibrary } from '@/attachments/pick';
...
const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(
  (
    { onSend, onStop, isStreaming, disabledReason, onDisabledPress, onLayout },
    ref,
  ) => {
    ...
    const canSend = (text.trim().length > 0 || files.length > 0) && !blocked;
