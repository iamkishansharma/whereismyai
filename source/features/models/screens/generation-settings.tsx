...
import { DEFAULT_GENERATION_SETTINGS } from '@/features/models/constants';
...
const KNOBS: Knob[] = [
  ...
  },
  {
    ...
    hint: 'Tokens of history the model sees. Defaults to what this model supports, capped for memory. Reloads the model.',
    min: 512,
    max: 8192,
    step: 512,
  },
